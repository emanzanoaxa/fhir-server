        ...
        public FhirStorageTests(FhirStorageTestsFixture fixture)
        {
            ...
            resourceWrapperFactory
                ...
                .Returns(x =>
                {
                    ...
                    return new ResourceWrapper(resource, rawResourceFactory.Create(resource), null, new ResourceRequest(HttpMethod.Post, "http://fhir"), x.ArgAt<bool>(1), null, null, null);
                });
